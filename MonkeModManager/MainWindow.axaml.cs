...
public partial class MainWindow : Window
{
    ...
    private async Task InitializeAsync()
    {
        ...
        var newVersion = new Version(1, 4, 0);
            ...
            client.SetPresence(new RichPresence
            {
                Buttons = new[]
                {
                    new DiscordRPC.Button
                    {
                        ...
                        Url = "https://github.com/SlitzyCodesTooMuch/Monke-Mod-Manager-Fixed/releases"
                    },
                },
                Details = "Modding",
    ...
    {
        using var client = new HttpClient();
        const string url = "https://raw.githubusercontent.com/SlitzyCodesTooMuch/updated-modlist-for-MonkeModManager-by-Graze/refs/heads/main/modinfo.json";
    ...
    async Task FixUEConfig()
    {
        ...
        {
            Console.WriteLine($"FUCK, it didnt work :angry_slitzy: {ex.Message}");
    ...
    private bool IsModInstalled(Mod mod)
    {
        ...
        try
        {
            ...
            {
                var appData = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
                var trackingFile = Path.Combine(appData, "SlitzyModManager", $".{mod.Name}_installed.txt");
